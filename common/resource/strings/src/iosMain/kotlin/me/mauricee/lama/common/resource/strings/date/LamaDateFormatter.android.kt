...
@ActivityScope
@Inject
actual class LamaDateFormatter(
    ...
    private val shortTime by lazy {
        NSDateComponentsFormatter().apply {
            ...
            calendar = this@LamaDateFormatter.calendar
        }
    }
    ...
    actual fun formatMonthAndYear(date: LocalDate): String {
        return monthYearFormatter.stringFromDate(date.toNSDate())
    }

    private fun LocalDate.toNSDate(calendar: NSCalendar = NSCalendar.currentCalendar): NSDate {
